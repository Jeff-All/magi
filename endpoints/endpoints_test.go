...
func TestHandleError(t *testing.T) {
	Convey("Unit Tests for endpoints", t, func() {
		...
		Convey("=", func() {
			out_clause, out_argument, out_error := endpoints.ParseWhereParam(TestModel{}, "FieldA=test")
		...
		Convey("Not Like", func() {
			out_clause, out_argument, out_error := endpoints.ParseWhereParam(TestModel{}, "FieldA!%test%what")
			So(out_error, ShouldBeNil)
		...
		Convey("In", func() {
			out_clause, out_argument, out_error := endpoints.ParseWhereParam(TestModel{}, "FieldA[test,test2]")
			So(out_error, ShouldBeNil)
		...
		Convey("And", func() {
			out_clause, out_argument, out_error := endpoints.ParseWhereParam(TestModel{}, "FieldA![test,test2]+FieldB=test3")
			So(out_error, ShouldBeNil)
